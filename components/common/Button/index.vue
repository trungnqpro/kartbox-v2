...
import UIcon from '~/components/common/Icon/index.vue'
import ULink from '~/components/common/Link/index.vue'
...
const config = mergeConfig<typeof button>(appConfig.ui.strategy, appConfig.ui.button)
