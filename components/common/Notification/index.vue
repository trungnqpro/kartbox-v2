                ...
                <div :class="ui.padding">
                    <div class="flex gap-3"
                        ...
                        <div class="w-0 flex-1">
                            ...
                            <div v-if="(description || $slots.description) && actions.length"
                                class="mt-3 flex items-center gap-2">
                                <UButton v-for="(action, index) of actions" :key="index"
                                    v-bind="{ ...ui.default.actionButton, ...action }" @click.stop="onAction(action)" />
                            </div>
                        </div>
                        <div class="flex-shrink-0 flex items-center gap-3">
                            ...
                            <UButton v-if="closeButton" aria-label="Close"
                                v-bind="{ ...ui.default.closeButton, ...closeButton }" @click.stop="onClose" />
                        </div>
                    </div>
                </div>
...
const config = mergeConfig<typeof notification>(appConfig.ui.strategy, appConfig.ui.notification)
