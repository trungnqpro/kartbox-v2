  ...
  <div>
    <div class="flex justify-between pt-[70px] container">
      <div class="text-[48px] font-semibold gap-y-[20px]">
        ...
        <div class="text-[22px] gap-y-[20px] flex justify-between max-w-[60%] pt-[5%]">
          <button class="w-[254px] h-[70px] rounded bg-[#FF9900]">
            Explore More
          </button>
          <button
            class="w-[254px] h-[70px] rounded border border-yellow-400 hover:border-yellow-500"
          >
            Create Your Space
          </button>
        </div>
      </div>
      <img src="@/assets/images/home-images/NFT_Cards.png" alt="" />
    </div>
    <div class="absolute bottom-[5%]">
      <img src="@/assets/images/home-images/MilkyWay.png" alt="" />
    </div>
  </div>
</template>
